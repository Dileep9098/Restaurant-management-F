...
export default function Item() {
    ...
    //         (item.restaurant?.name || '').toLowerCase().includes(restaurantNameFilter.toLowerCase());
    ...
    //     if (selectedFilter === 'veg') filterCondition = item.isVeg && !item.isNonVeg;
    //     else if (selectedFilter === 'non-veg') filterCondition = !item.isVeg && item.isNonVeg;
    //     else if (selectedFilter === 'veg-non-veg') filterCondition = item.isVeg && item.isNonVeg;
    //     else if (selectedFilter === 'active') filterCondition = item.isActive;
    //     else if (selectedFilter === 'inactive') filterCondition = !item.isActive;
    ...
    // const vegItems = filteredMenuItems.filter(i => i.isVeg && !i.isNonVeg).length;
